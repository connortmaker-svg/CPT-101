...
print("3. Turn back and go the the tavern for a drink")
...
# Branch 1 Start
if int_choice == "1":
    print("\nYou enter with the sword, but it is extremly dark in the cave!/\n")
...
# Branch 3 Start
    ...
    if choice_23 == "1":
        print("\nThe drink was actually a poison that an evil witch had left behind. You have died from poisioning")
    elif choice_23 == "2":
        print("\nThe blacksmith is a Tibeton Monk. He ends your journey with a single punch.")
    elif choice_23 == "3":
        print("\nA spark jumps from the fire and ignites your cloak and you. You have been toasted")
    else:
        print("\nInvalid Input: You stood in the doorway to long and got trampled by a horse")
